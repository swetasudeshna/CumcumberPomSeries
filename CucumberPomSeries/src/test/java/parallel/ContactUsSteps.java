...
public class ContactUsSteps 
{
	...
	public void user_fills_the_form_from_given_sheetname_and_rownumber(String sheetName, Integer rowNumber) throws InvalidFormatException, IOException
	{
	   ...
	   List <Map <String, String>>testData=reader.getData("/C:/Users/sweta/OneDrive/Desktop/automation.xlsx",sheetName );
	...
	public void it_shows_a_successful_message(String expSuccessMessage) {
		...
		String actualSucessMessage=contactUsPage.getSuccessMessg();
		Assert.assertEquals(actualSucessMessage, actualSucessMessage);
	}
